...
public class DespesaComInternet extends Despesa {
    ...
    public double calcularTotal() {
        ...
        else if (dadosTrafegados > 20 && dadosTrafegados < 100) valorFinal = 90.9 + ((dadosTrafegados - 20) * 3.9);
        else if (dadosTrafegados == 100) valorFinal = 240.9;
        else if (dadosTrafegados > 100 && dadosTrafegados < 500) valorFinal = 240.9  + ((dadosTrafegados - 100) * 4.4);
        else if (dadosTrafegados == 500) valorFinal = 590.9;
